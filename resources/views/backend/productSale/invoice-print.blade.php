            ...
            <div id="printArea">
                ...
                <div class="page-header" style="text-align: center">
                    <div class="row" style="padding-top: 22px;">
                        <div class="col-md-6" style="width: 30%; float: left;display: inline-block">&nbsp;</div>
                        <div class="col-md-6" style="text-align: right; width: 70%; display: inline-block">
                            <div class="invoice-logo mr-5">
